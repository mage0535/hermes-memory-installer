...
def classify_entry(entry: str):
    ...
    # 最新 Kiki (05/14) - 保留
    if "kiki 05/14" in e or "kiki 05-14" in e: return None, None, False
    ...
    # 可归档的老条目
    # Kiki 条目 → gbrain + Hindsight (经验类)
    if False and ("kiki" in e and ("5/12" in entry or "05/12" in entry or "5/13" in entry or "05/13" in entry)):
        return ("kiki-chat-archive-2024-2026", entry[:150], True)
