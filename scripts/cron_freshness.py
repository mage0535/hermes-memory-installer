...
CHECKS = [
    {"name": "langsmith_monitor", "path": AGENT_HOME / "metrics" / "langsmith-monitor-latest.json", "max_age_s": 8 * 3600},
    {"name": "langsmith_trend", "path": AGENT_HOME / "metrics" / "langsmith-trend-latest.json", "max_age_s": 8 * 3600},
    ...
    {"name": "slo_rollup", "path": AGENT_HOME / "metrics" / "slo-rollup-latest.json", "max_age_s": 3600},
