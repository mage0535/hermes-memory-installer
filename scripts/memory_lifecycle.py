...
PROTECTED_SLUGS = ["kiki-chat-archive-2024-2026", "hub-system-operations", "hub-stock-analysis", "hub-promotion-matrix"]
PROTECTED_TAGS = ["archive", "hub", "config", "protected", "kiki"]
STALE_AFTER_DAYS = 90
